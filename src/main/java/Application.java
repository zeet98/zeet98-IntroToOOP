public class Application {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("This bird is 2 months old, and should Tweet.");
        Bird b1 = new Bird();
        b1.ageMonths = 2;
        System.out.println(b1.sound());

        System.out.println("This bird is 6 months old, and should Chirp.");
        Bird b2 = new Bird();
        b2.ageMonths = 6;
        System.out.println(b2.sound());

        System.out.println("This bird is 3 months old, and should Chirp.");
        Bird b3 = new Bird();
        b3.ageMonths = 3;
